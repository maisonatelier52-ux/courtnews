...
const Footer = () => {
  const categories = Object.keys(categoryPageData).slice(0, 7);
    ...
    <footer className="bg-[#111] text-white pt-10 pb-5 w-full mt-auto">
      <div className="max-w-[1250px] mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4">
        ...
        <div className="space-y-4">
          ...
          />
          <p className="text-sm text-gray-300 leading-relaxed">
            Court News is a U.S.-based legal news platform covering courts,
            crime, civil rights, investigations, and law &amp; justice across
            America.
          </p>
          <p className="mb-4 font-semibold text-lg text-center md:text-left text-white">Follow Us</p>
          <div className="flex justify-center md:justify-start gap-5 text-2xl text-gray-300 mb-6">
            <Link
        ...
        {/* ── Policy & Trust Links ── */}
        <div>
          <p className="mb-4 font-semibold text-lg text-white">Standards</p>
          <div className="grid grid-cols-2 gap-x-6 gap-y-2 text-sm text-gray-300 md:flex md:flex-col md:gap-2">
        ...
        <div className=" md:text-left">
          ...
          <p className="mb-4 font-semibold text-lg text-white"></p>
           <div className="grid grid-cols-2 gap-x-6 gap-y-2 text-sm text-gray-300 md:flex md:flex-col md:gap-2">
            {policyLinks2.map((link) => (
              <Link
                key={link.href}
                href={link.href}
                title={link.label}
