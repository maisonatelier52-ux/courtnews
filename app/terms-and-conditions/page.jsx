...
export const metadata = {
  ...
  description:
    "Official Terms and Conditions for using CourtNews, including content usage rights, disclaimers, and limitations of liability.",
  keywords:
    "terms and conditions, legal terms, copyright, disclaimer, liability, courtnews terms, user agreement",
  robots: {
    index: true,
    follow: true,
    googleBot: {
  ...
  alternates: {
    canonical: `${SITE_URL}/terms-and-conditions`,
    languages: {
      "en-US": `${SITE_URL}/terms-and-conditions`,
    },
  },
  openGraph: {
    title: "Terms and Conditions | CourtNews",
...
export default function TermsAndConditions() {
  ...
  // JSON-LD for WebPage (main page schema)
  const webpageJsonLd = {
    "@context": "https://schema.org",
    "@type": "WebPage",
    name: "Terms and Conditions",
  ...
  // Organization JSON-LD (for consistency)
      ...
      <main className="mx-auto max-w-7xl px-4 sm:px-6 py-16 md:py-15 bg-white min-h-screen">
        <div className="max-w-4xl mx-auto prose prose-lg prose-indigo">
          <div className="text-center mb-16">
            ...
            <p className="terms-intro text-lg text-gray-600">
              Last updated: February 9, 2026
            </p>
          </div>
